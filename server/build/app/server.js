...
var server = (io, connection) => {
    const rs = new room_socket_1.RoomSocket(io); // setting up functionality of rooms
    const ms = new message_socket_1.MessageSocket(io, rs); // setting up functionality of messages
    const gs = new group_socket_1.GroupSockets(io, rs); // setting up functionality of groups
